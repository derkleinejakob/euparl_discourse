...
## define some helper functions for string/name normalization
...
# 02_helper function for lists (creates a normalized set)
...
# 03_helper function for "stricter normalization"
...
#    "Nότης Μαριάς"          # needs Unidecode to transliterate well
#]
#for t in tests:
