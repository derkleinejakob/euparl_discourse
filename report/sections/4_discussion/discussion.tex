...
Dimensionality reduction reveals two axes that separate parties in semantic space. The first axis could tentatively be interpreted as \emph{conciliatory} $\Leftrightarrow$ \emph{oppositional} mode of migration discourse. The second axis is less distinct and is driven by extreme cases referencing security-related concerns, particularly in an Eastern European context, suggesting a \emph{moral} $\Leftrightarrow$ \emph{pragmatic-benefits / security} dimension. The variable validation score indicates overlap between party blocs, suggesting that the recovered dimensions capture tendencies rather sharp boundaries.
