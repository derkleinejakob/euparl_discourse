...
Far-right parties appear to employ agenda-setting behavior by introducing migration-speech into debates, particularly about economy and security. 
For other party blocs, this phenomenon is too rare to assert a definite pattern and could partly represent LDA misclassifications. %However, there are indications of a polar divide: Green and left parties tend to introduce migration to debates on humanitarian issues. Furhter research can examine whether such a left-right distinction shapes where migration discourse is fed into the debate.
