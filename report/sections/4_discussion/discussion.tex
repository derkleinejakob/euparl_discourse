...
Dimensionality reduction via PLS reveals two largely interpretable axes separating parties in semantic space. The first axis is clearly interpretable, while the second is less distinct and characterized by extreme examples in positive direction referencing security concerns in Eastern Europe. Although a definitive interpretation of the underlying political dimensions requires substantial domain knowledge, word associations and extreme speeches along each axis permit tentative conclusions. Despite the noisy nature of general-purpose embeddings, the strong party separation along the axes supports cautious interpretation. We interpret the first PLS axis as a
