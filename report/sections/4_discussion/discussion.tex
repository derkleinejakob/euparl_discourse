...
PLS reveals largely interpretable axes separating parties in semantic space. The first axis is clearly interpretable, while the second is less distinct and characterized by extreme examples in positive direction referencing security concerns in Eastern Europe. Although a definitive interpretation of the underlying political dimensions requires substantial domain knowledge. Despite the noisy nature of general-purpose embeddings, word associations and extreme speeches permit tentative conclusions. We interpret the first PLS axis as a
