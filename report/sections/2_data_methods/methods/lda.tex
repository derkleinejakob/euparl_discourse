...
and classifying whether they were migration-related. Using operating characteristic analysis, we identified the threshold that minimized the difference between true and false positive rates. %(prob = 0.25).
