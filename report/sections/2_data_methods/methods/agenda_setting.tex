...
For this purpose, we look at debates where all migration-related speeches stem from the same party bloc, indicating that migration is fed into the discussion by that group despite not being the main topic. We define such a debate as an instance of agenda-setting and assign each debate a `true' topic: the topic with highest mean probability among its speeches.