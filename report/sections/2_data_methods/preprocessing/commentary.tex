...
There are also substantial redundencies in the openning and closing sections of the speeches (greetings, etc.). These sections follow similar rhetorical structures but exhibit substantial lexical variation. To remove redundant formalities, we identify low-impact sentences using TF-IDF which scores the amount of information of a sentence (TODO, source). %[TODO: add source / publication where TF-IDF was first published]
