...
We use the ParlLawSpeech dataset \citep{SDN-10.7802-2824}, which contains the full verbatim transcriptions of parliamentary debates between 1999 and 2024 with rich metadata. We restrict the analyses to last two complete legislative periods (2014–2024), as the 2015/2016 “refugee crisis” could mark a qualitative shift in the nature and salience of migration debates that might bias topic-model estimation. In a preliminary test, evidence for this effect was reflected by an increase in migration-labeled speeches from around 1\% before 2014 to over 2.5\% thereafter.
...
In 2015 and 2016, the total number of speeches increases sharply (over 50,000 per year), compared to an average of 10,098 in other years (\textit{SD} = 2,724). %, reflecting a shift from numerous, shorter to fewer and longer speeches over time.
This phenomenon is explained by changes in parliamentary procedure adopted at the end of 2016 \citep{tremblay2024open}, most notably the discontinuation of short written statements expressing opinions on specific issues. %Their removal largely normalizes annual speech counts.
