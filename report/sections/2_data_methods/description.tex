...
\textbf{2015 and 2016 anomaly} In 2015 and 2016, there is a drastic increase in total speech number (more than 50,000 per year) compared to the other years' average of 10,098 (\textit{SD = 2,724.43}), reflecting 
a general shift from numerous, shorter to fewer and longer speeches over time.
This phenomena can be explained with changes in EP procedure adopted by parliament in December 2016 and January 2017 \citep{tremblay2024open}, including the discontinuation of so-called 'written declarations' that
allowed party members to hand in short written expressions of opinion on certain issues (also marked as 'written' in the PLS dataset). Their omission normalizes the number of speeches per year. 
For general analysis, however, we keep the written declarations as they can contain relevant stances of parties on political issues. 
Since these declarations could be co-signed by multiple speakers, they can appear duplicated in the dataset in which case we only keep the first instance.
%
