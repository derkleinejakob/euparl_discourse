...
\caption{LDA results. \textbf{Top:} Number of speeches for selected topics in EP debates, divided by total number of speeches per year. See repository for an interactive version with all topics.
