...
PLS identifies directions in the embedding space that seperate the party blocs meaningfully, with an averaged, cross-validated F1 score of $0.45 \pm 0.35$ (mean $ \pm$ std. accross validation folds). To interpret the identified axes, embeddings of the full vocabulary were reduced to the two-dimensional space, and the most extreme per axis were selected as labels (Figure \ref{fig:fig3_pls}).
